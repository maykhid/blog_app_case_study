...
class GetBlogPostsWithAuthorsUseCase {
  const GetBlogPostsWithAuthorsUseCase({required BlogPostsRepository blogPostsRepository})
  ...
  Future<Resource<PostsWithAuthors>> call() async {
    ...
    var authors = authorsResource.data?.users;
    var posts = postsResource.data?.posts;
