...
class HiveAuthorsDao implements AuthorsDao {
  ...
  @override
  void cacheAuthors({required AuthorsResponse authors}) => _authorsBox
      .put(_authorsKey, authors)
      .onError((error, stackTrace) => throw LocalStorageException(
          "Caching authors failed: ${error.toString()}"));
